...
//        data[9] = new Question(10, "", "");
    ...
    static void question1() throws InterruptedException {
        ...
        System.out.println(
                "class Test1 {\n" +
                        "    public static void seDay01(String[] args) {\n" +
                        "        /**\n" +
                        "         * 1.接收使用者輸入的題示:\n" +
                        "         * 1-1提示使用者輸入\n" +
                        ...
                        "             */\n" +
                        "            File file = new File(\"src/seDay01/java/homework/day01/seDay03.demo/\" + user);//綁定要生成的對象\n" +
        ...
        while (true) {
            ...
            //預處理，排他
            if ("EXIT".equals(user.trim().toUpperCase())) {//不分大小寫出現exit即退出循環
                break;//應用戶要求退出程序，此處應改為退出循環並非結束方法(不同於Test1.seDay01())
            }
            ...
            //比對
            File file = new File("src/seDay01/java/homework/day01/seDay03.demo/" + user);//綁定對象
            if (file.exists()) {//已存在
                System.out.println("警告:文件名已重複，請重新輸入");
            } else {//不存在
                ...
                if (result) {//創建成功
                    ...
                    break;//此處應改為退出循環並非結束方法(不同於Test1.seDay01())
                }
    ...
    static void question2() throws InterruptedException {
        ...
        System.out.println(
                "class Test2 {\n" +
                        "    public static void seDay01(String[] args) {\n" +
                        "        File file = new File(\"src/seDay01/java/homework/day01/seDay03.demo\");//綁定文件地址\n" +
                        "        /**\n" +
        ...
        willShowURun();
        //背景代碼存放區開始----------------------------------------
        File file = new File("src/seDay01/java/homework/day01/seDay03.demo");//綁定地址
        //inner
    ...
    static void question3() throws InterruptedException {
        ...
        System.out.println(
                "class Test3 {\n" +
                        ...
                        "         * \"./src/seDay01/java/homework/day01\"才是表示當前目錄\n" +
                        "         */\n" +
                        "//\t\t  File dir = new File(\".\");//定位当前目录\n" +
                        "        File dir = new File(\"src/seDay01/java/homework/day01\");\n" +
                        "\n" +
                        "        /**\n" +
                        "         * 沒毛病\n" +
                        "         */\n" +
