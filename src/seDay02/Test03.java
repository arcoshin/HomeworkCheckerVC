...
class Test03 {
    public static void main(String[] args) {
        ...
        try (//main方法一般不拋異常，此處亦可自動關流釋放資源
                FileInputStream fis = new FileInputStream("src/seDay02/seDay03.demo/test.txt");
...
//                BufferedInputStream bis = new BuffereddInputStream(fis);
                ...
                FileOutputStream fos = new FileOutputStream("src/seDay02/seDay03.demo/test_cp2.txt");
...
//            System.out.println("複製完畢!");
             ...
             * 打樁驗證
             */
            File file1 = new File("src/seDay02/seDay03.demo/test.txt");
            File file2 = new File("src/seDay02/seDay03.demo/test_cp2.txt");
